...
- ADR deps (Zoho = REST sin SDK): `plans/reports/adr-auditoria-dependencias-20260520.md` §Sprint 2
...
- `af-agents:api` — OAuth routes + webhook endpoint + channel manager
- `af-agents:code` — adapter, crm-client, field metadata
