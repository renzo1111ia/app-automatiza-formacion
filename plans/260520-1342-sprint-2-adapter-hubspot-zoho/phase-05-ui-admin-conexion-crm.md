...
- Field mapping phase: `plans/260520-1342-sprint-2-adapter-hubspot-zoho/phase-04-field-mapping-write-policy.md`
- HubSpot adapter OAuth routes: `plans/260520-1342-sprint-2-adapter-hubspot-zoho/phase-02-adapter-hubspot.md`
- Zoho adapter OAuth routes: `plans/260520-1342-sprint-2-adapter-hubspot-zoho/phase-03-adapter-zoho.md`
...
- `af-agents:uxui` — diseño componentes + layout
- `af-agents:code` — Server Actions + integración repositories
