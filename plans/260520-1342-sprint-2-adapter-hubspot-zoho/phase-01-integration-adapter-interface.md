...
- RoadMap: `plans/RoadMap.md` §Fase 2, tarea 3-01
...
- Sprint 1 Phase 03 (integrations-repository 2-18): `plans/260520-1342-sprint-1-capa-datos/phase-03-repository-pattern.md`

## Overview

- **Prioridad:** P1
- **Estado:** Pendiente — puede iniciar en paralelo con Sprint 1 si 2-11 (Zod schemas integrations) está disponible
...
3. Crear `_integration-adapter-factory.ts`:
   - Importar `integrationsRepository` de Sprint 1
...
|--------|------|---------|-----------|
| Sprint 1 2-18 no disponible al iniciar | Media | Bajo | Si 2-18 no está: escribir interface + factory con tipo inline provisional, refactorizar cuando 2-18 entregue |
...
- `af-agents:code` — implementación TypeScript
