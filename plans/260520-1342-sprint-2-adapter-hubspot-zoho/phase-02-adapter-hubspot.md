...
- Interface base: `plans/260520-1342-sprint-2-adapter-hubspot-zoho/phase-01-integration-adapter-interface.md`
- R-014 (append-only): `docs/audit/DECISIONES-AUDITOR-JAVIER-HP.md#r-014`
- ADR deps (HubSpot SDK confirmado): `plans/reports/adr-auditoria-dependencias-20260520.md` §Sprint 2
- Sprint 1 2-26 (cifrado tokens): `plans/260520-1342-sprint-1-capa-datos/phase-06-rls-hardening-complementario.md`
...
1. **ADR formal:** solicitar aprobación `af-agents:adr` para instalar `@hubspot/api-client@^13.5.0`
...
- `af-agents:api` — OAuth routes + webhook endpoint
- `af-agents:code` — adapter, crm-client, webhook handler
