...
last_updated: 28-05-2026 ~sync sesión lint-zero + hardening-deploy Sprint 3
last_updated_by: roadmap-keeper (28-05-2026 — sync sesión 28-05: (1) Cuadro mando Sprint 3: 🔘→🟡 En Desarrollo, ⏱ Push agregado ~21h. (2) Tabla detallada Fase 3: 13 tareas 🟡→🔵 Subida rama (AWS-REMOVAL, SIDEBAR-UX, BUG-3-01..13, TS-STANDARDS, AUTH-RATELIMIT, SEC-PROACTIVE, RLM-TIMEOUT). SP-4-LINT-ZERO: 🔘→🔵, ⏱ Push 5h 30min, 9 commits e39b059..9e7201f. Añadidas 2 filas nuevas: SP-4-DEPRECATIONS-DEPLOY 🔵 ⏱ Push 2h 30min (6d238f4..0912dc7) + SP-4-INCIDENT-PAT-LEAK-260527 🟡 ⏱ Push ~15min (612c207). Subtotal Fase 3 actualizado ~21h real. 17 commits total en feature/sprint-03-hardening sin merge a developer — CLOSE-1..5 pendientes.)
...
| Item                                           | Estado           | Estim.        | ⏱ Push | ⏱ Cierre | Notas                                                                         |
| ---------------------------------------------- | ---------------- | ------------- | ------ | -------- | ----------------------------------------------------------------------------- |
| **🚀 Sprint 3**                                | 🟡 En Desarrollo | **~112-144h** | ~21h   | —        | **v0.3.0-rc.1** (release candidate) · … _ver nota↓_                           |
...
> **Nota fila `🚀 Sprint 3` · Notas**: **v0.3.0-rc.1** (release candidate) · `feature/sprint-03-hardening` · Inicio Vie 31-07-2026 · **planificación detallada actualizada 24-05-2026 tras research R2**: phase-08 nueva con NEW-09..12 desglosadas (19-25h), phase-05 horas corregidas 10-14h → 16-20h (incluye 4-08 withRateLimit HOF), phase-07 versión unificada (3 valores conflictivos → `v0.3.0-rc.1` único), CHANGELOG borrador phase-06 actualizado (eliminar items LLM movidos, añadir Node 22 + NEW-09..12) · **Sesión 28-05-2026**: SP-4-LINT-ZERO (9 lotes, lint 104→0) + SP-4-DEPRECATIONS-DEPLOY (Next 16 + Sentry 10 + lazy SERVICE_ROLE_KEY + fix /api/version) + doc incidente PAT leak. ⏱ ~21h totales pusheadas, sin PR a developer todavía.
>
