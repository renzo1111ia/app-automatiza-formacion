...
last_updated_by: agente roadmap-keeper (25-05-2026 08:15 — Sprint 2B CERRADO v0.2.8: 15/15 E2E Playwright VPS verdes contra dev.automatizaformacion.com (Dokploy deploy correcto, ETag cambiada `778yfwjt2f6lb`→`xpftxrxk886lb`), bump package.json 0.2.7→0.2.8, RELEASE-NOTES-v0.2.8.md redactadas, hand-off SP-4B phase-03b auto-filled (todos los AUTOFILL blocks), tag v0.2.8 pendiente push. Nueva tarea SP-4-NEW-13 (endpoints /api/health + /api/version) añadida a Sprint 3 phase-02 tras detectar fricción de ETag opaco en CLOSE-5)
project_version: v0.2.7
versioning_policy: "Rebajada 24-05-2026 por decisión Javi HP. Mapa nuevo: Sprint 0=v0.1.0, Sprint 1=v0.2.0, Sprint 2=v0.2.7 (final con hotfix BUG-2-01), Sprint 2B=v0.2.8, Sprint 3=v0.3.0-rc.1, SP-4B Validación MVP GA=v0.3.0, Sprint 4 Sheets=v0.4.0, Sprint Costes-LLM=v0.4.1, Sprint Refinamiento=v0.4.2, Sprint 5 Salesforce=v0.5.0, etc."
...
| Item                                  | Estado            | Estim.              | ⏱ Push    | ⏱ Cierre  | Notas                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------- | ----------------- | ------------------- | --------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 2B**                      | 🟢 **COMPLETADA** | **16-24h + cierre** | ~2h 08min | ~2h 23min | **v0.2.8** · `feature/sprint-02b-dashboard-kpis-conjunto` · **Inicio REAL 24-05-2026 21:25** · **Fin REAL 25-05-2026 08:15 UTC** · PR #13 mergeado (`17b2902`) + bump v0.2.8 (`bbcbfd0`) + tag + release. **15/15 E2E VPS verdes** contra `dev.automatizaformacion.com`. 3 bugs resueltos (BUG-2B-01/02/03). Hand-off SP-4B phase-03b auto-filled. Ratio −86%. Release: [v0.2.8](https://github.com/AutomatizaFormacion/Automatiza-Formacion-DashBoard/releases/tag/v0.2.8). |
...
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sprint ID**                  | `SP-3B`                                                                                                                                            |
| **Versión objetivo al cierre** | `v0.2.8`                                                                                                                                           |
| **Estado del sprint**          | 🟢 **CERRADO v0.2.8** 25-05-2026 ~08:15 UTC · PR #13 mergeado `17b2902` · Dokploy deploy verde · 15/15 E2E VPS verdes · hand-off SP-4B auto-filled |
...
| **Subtotal Sprint 2B**             |                                                                        | ~16h30min |               | ~2h 08min | ~2h 23min |           | ~2h 23min total (1h 53min dev + 15min CLOSE-5 push + ~15min E2E VPS + ~30min cierre) vs 16h 30min estim (ratio −86%) |
...
| **Subtotal cierre Sprint 2B** |                                                                              | **4h 30min + bugs** |               | 15min  | ~30min   | ✅ TODOS los CLOSE-1/2/4/5 🟢 · CLOSE-3 diferido SP-4B phase-03b                                                            |
...
| **Subtotal Fase 3 — Desarrollo** |                                                                                                                                                                        | **93-124h**         |              | Objetivo base 99h (+4h por SP-4-NODE-22 + 30min-1h por SP-4-NEW-13). + 8h cierre phase-07. Total 101-132h con cierre. Histórico: -21h tras mover 4-04 + parte 4-03 al Sprint Costes-LLM post-MVP (22-05-2026); +4-6h SP-4-NODE-22 + 30min-1h SP-4-NEW-13 (24-25-05-2026) |
