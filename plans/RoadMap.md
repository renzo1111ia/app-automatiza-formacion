...
| SP-4-NEW-11                      | Rename UI Historial → Leads + consolidación menús/labels/breadcrumbs/rutas. HACER ANTES de phase-01 E2E para evitar specs Playwright con nombres viejos                                           | 2h                  | 🔘 Pendiente | phase-08 Sprint 3 (Bloque 3.B). BLOQUEANTE de phase-01 (E2E Playwright). Detalle: `plans/260520-1342-sprint-3-hardening/phase-08-features-bloque-3b.md`. Decisión Bea (22-05-2026) reforzada 24-05: "Leads" alineado con vocabulario del sector formativo                                     |
