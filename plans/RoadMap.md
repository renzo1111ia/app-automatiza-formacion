...
last_updated_by: Javi HP (24-05-2026 ~20:50 — planificación detallada Sprint 2B + Sprint 3 + SP-4B basada en 3 researchers paralelos. Sprint 2B: 7 phase files creados, v0.2.7 → v0.2.8. Sprint 3: phase-08 NEW-09..12 desglosado (19-25h), versión unificada v0.3.0-rc.1, phase-05 horas corregidas (16-20h), CHANGELOG borrador actualizado, phase-08 añadido al índice (total 112-144h). SP-4B: phase-03 dividida en phase-03a (Sprint 2 rellenada con BUG-2-01+F-*) + phase-03b (Sprint 2B skeleton AUTOFILL), phase-04 expandida con 5 subdominios + env vars probables, versiones corregidas v0.4.0→v0.3.0. RoadMap actualizado con todos los cambios.)
...
| Item                                  | Estado       | Estim.              | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------- | ------------ | ------------------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 2B**                      | 🔘 Pendiente | **16-24h + cierre** | —      | —        | **v0.2.8** (bumpeado de v0.2.7 por colisión con Sprint 2 hotfix) · `feature/sprint-02b-dashboard-kpis-conjunto` · Inicio Lun 27-07-2026 (REVISAR: Sprint 2 cerró antes el 24-05-2026, posible adelantar) · creado 22-05-2026 por requerimiento Bea, **planificación detallada 24-05-2026 (7 phase files)** tras research R1 que confirmó dashboard ya existe (enhancement, no greenfield). Detalle: [`plans/260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md`](260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md) |
| ▸ Tareas de desarrollo                | 🔘           | 16-24h              | —      | —        | 0/1 · **NEW-04** Dashboard KPIs conjunto. **Planificación detallada 24-05-2026**: 7 phase files (decisión arquitectónica + getKpiOverview + OverviewSection + charts + KPI builder + WCAG + cierre). **Decisión R1**: extender `/dashboard` existente con `<OverviewSection>` (zero-migration, reusa `getKpiGenerales()`). Persistencia en `tenants.config.overview_kpis` JSONB. 4 KPIs hero + 4 charts default + KPI Builder. WCAG preventivo (3 pitfalls).                                                               |
