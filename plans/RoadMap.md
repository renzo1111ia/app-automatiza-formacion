...
| ▸ Phase 02 Zoho multi-DC bugfixes (B-01..B-07) | 🔘 Pendiente         | 10h                              | —      | —        | Próxima sesión. Punto entrada: [phase-02](260524-1330-sprint-2-adapter-hubspot-zoho/phase-02-zoho-multidc-bugfixes.md). Crítico: B-01/B-02 (multi-DC hardcoded US rompe clientes EU/AU/IN).                                                                                                                                                                                                                                                                             |
| ▸ Phase 03 HubSpot Public App OAuth            | 🔘 Pendiente         | 16h                              | —      | —        | Próxima sesión. **Bloqueante**: usuario debe registrar Public App en HubSpot Developer Portal antes (obtener CLIENT_ID + CLIENT_SECRET).                                                                                                                                                                                                                                                                                                                                |
| ▸ Phase 04 WriteGuard + audit log              | 🔘 Pendiente         | 6h                               | —      | —        | Próxima sesión. Tabla `crm_write_audit` ya creada en Phase 01 — falta función `applyWritePolicy` + tests + audit-query helper.                                                                                                                                                                                                                                                                                                                                          |
| ▸ Phase 05 UI admin IntegrationsManager        | 🔘 Pendiente         | 12h                              | —      | —        | Próxima sesión. Depende de 02+03+04 ✅. WCAG 2.2 AA obligatorio.                                                                                                                                                                                                                                                                                                                                                                                                        |
| ▸ Phase 06 Tests + docs + ADRs 021/022         | 🔘 Pendiente         | 10h                              | —      | —        | Próxima sesión. Cobertura ≥80% en `crm/`. ADRs sobre write_policy semantics y TokenManager dedup. Actualizar `help_sections` con sección "integrations".                                                                                                                                                                                                                                                                                                                |
| ▸ Phase 07 Cierre (SP-3-CLOSE-1..5)            | 🔘 Pendiente         | 6h + bugs                        | —      | —        | Sigue [Protocolo estándar de cierre](#protocolo-estándar-de-cierre-de-sprint-close-1-5--paso-6-condicional) · CLOSE-3 **DIFERIDO a SP-4B phase-03 bloque 4** · paso 7 E2E VPS condicional (omitido hasta despliegue VPS) · paso 8 hand-off SP-4B obligatorio.                                                                                                                                                                                                           |
