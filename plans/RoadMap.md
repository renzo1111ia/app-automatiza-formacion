...
last_updated_by: agente roadmap-keeper (24-05-2026 23:30 — sincronizando Sprint 2 CERRADO v0.2.7 (bloques 3.0..3.7 → 🟢, tareas individuales → 🟢, SP-3-CLOSE-1..5 ya estaban 🟢 en cuadro de mando) + Sprint 2B 6/7 phases completadas (phase-07 + E2E VPS pendientes) + añadida Fase 2.5 sección detallada)
...
sprint_2b_progress: "🟡 EN DESARROLLO — Sprint 2B branch `feature/sprint-02b-dashboard-kpis-conjunto` · Inicio REAL 24-05-2026 21:25 · **v0.2.8** · 6/7 phases 🟢 (phase-01..06 completadas: DEFAULT_OVERVIEW_KPIS+Zod, getKpiOverview+mapper puro, OverviewSection en /dashboard, 4 charts integrados, KPI Builder opción C, WCAG role=img+chart-summary) · 193/193 tests Vitest verdes · CLOSE-1 🟢 (typecheck+build OK, lint 116 err preexistentes, 0 nuevos) · CLOSE-2 🟢 (7/7 E2C Playwright + 4 screenshots) · Phase-07 (PR + bump + hand-off SP-4B) 🔘 Pendiente · E2E VPS 🔘 Pendiente · ⏱ ~1h 25min real vs 16h 30min estim (ratio −91%)"
...
| ▸ Tareas de desarrollo                | 🟡 En Desarrollo | 16-24h              | —      | —        | 6/7 phases 🟢, phase-07 + E2E VPS 🔘 · **NEW-04** Dashboard KPIs conjunto · Detalle fino en sección `## Fase 2.5` más abajo · CLOSE-1 🟢 (193 tests, lint 116 err preexistentes 0 nuevos) · CLOSE-2 🟢 (7/7 E2C Playwright) · ⏱ ~1h 25min real vs 16h 30min estim (ratio −91%)                                                                                                                                |
| ▸ Cierre Sprint 2B (SP-3B-CLOSE-1..5) | 🔘 Pendiente     | **4h 30min + bugs** | —      | —        | Sigue [Protocolo estándar de cierre](#protocolo-estándar-de-cierre-de-sprint-close-1-5--paso-6-condicional) · CLOSE-3 **DIFERIDO a SP-4B phase-03b bloque 4** (Renzo) · paso 7 E2E VPS condicional (omitido si VPS no actualizado) · paso 8 hand-off SP-4B obligatorio                                                                                                                                        |
...
| **Estado del sprint**          | 🟡 En Desarrollo (6/7 phases 🟢 · phase-07 + E2E VPS 🔘)                                                                     |
...
| **Phase 07** Cierre                | CLOSE-5: PR a developer + bump v0.2.8 + hand-off SP-4B phase-03b       | 4h 30min  | 🔘 Pendiente  | —        | —        | —         | Pendiente orden usuario para push + PR                                                          |
| **E2E VPS**                        | Playwright contra dev.automatizaformacion.com post-merge               | —         | 🔘 Pendiente  | —        | —        | —         | Requiere merge PR developer → autodeploy → E2E spec                                             |
| **Subtotal Sprint 2B**             |                                                                        | ~16h30min |               | ~1h53min | ~1h53min |           | ~1h 53min real (push+cierre coincide; sin fixes post-merge aún) vs 16h 30min estim (ratio −89%) |
