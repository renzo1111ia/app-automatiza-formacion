...
last_updated: 24-05-2026 21:30
last_updated_by: Javi HP (24-05-2026 ~21:30 — **replanteo fechas MVP -7 sem por ratio real Sprints 0/1/2 (−91% a −94% vs estim por orquestación)**. MVP v0.3.0 GA: Lun 10-08-2026 → **Lun 22-06-2026**. Calendario nuevo: Sprint 2B Mar 26-05 a Jue 28-05 (3d) · Sprint 3 Vie 29-05 a Vie 12-06 (10-11d lab Javi HP) · SP-4B Renzo Mar 16-06 a Vie 19-06 (4-5d, 8h/d). Resoluciones de cuestiones abiertas: NEW-11=B (solo labels, URL queda) · KPI Builder=C (reusar SummaryManager + pestaña dedicada) · NEW-09 campaigns YA EXISTE sin penalización · ChartConfig funnel YA EXISTE en `ChartManager.tsx:108` · Web widget canal: 2 valores + tooltip "Web tracking en desarrollo". Memoria asociada: `project-decisiones-260524-2130.md`.)
...
| Item                                  | Estado        | Estim.              | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------- | ------------- | ------------------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 2B**                      | 🔘 Pendiente  | **16-24h + cierre** | —      | —        | **v0.2.8** · `feature/sprint-02b-dashboard-kpis-conjunto` · **Inicio Mar 26-05-2026 09:00 → Fin Jue 28-05-2026 19:00** (replanteo −7 sem aplicado 24-05-2026 21:30) · creado 22-05-2026 (Bea) · planif. detallada 24-05-2026 (7 phase files, R1) · 6 cuestiones abiertas RESUELTAS 24-05 21:30. Detalle: [`plans/260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md`](260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md) |
...
| ▸ Tareas de desarrollo                | 🔘 Pendiente  | 16-24h              | —      | —        | 0/1 · **NEW-04** Dashboard KPIs conjunto. 7 phase files · Decisión R1: extender `/dashboard` con `<OverviewSection>` (zero-migration, reusa `getKpiGenerales()`). Persistencia `tenants.config.overview_kpis` JSONB. 4 KPIs hero + 4 charts default (funnel YA EXISTE, donut canal=2 valores+tooltip) + KPI Builder opción C (SummaryManager + pestaña KPIs). WCAG preventivo (3 pitfalls).                                     |
