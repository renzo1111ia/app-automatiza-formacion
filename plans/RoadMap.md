...
last_updated_by: agente roadmap-keeper (25-05-2026 07:30 — Sprint 2B PR #13 MERGEADO a developer (merge `17b2902`): frontmatter sprint_2b_progress 🔵 + cuadro de mando L203 Tareas desarrollo 🟢 + L204 Cierre Sprint 2B 🔵 + Fase 2.5 Estado del sprint 🔵 + tabla resumen Phase 07 🔵 + E2E VPS 🟡 en curso autodeploy + Subtotal Sprint 2B push 2h 08min. Pendiente E2E VPS verde → bump v0.2.8 + tag + release notes + hand-off SP-4B phase-03b)
...
sprint_2b_progress: "🔵 SUBIDA RAMA + PR MERGEADO — Sprint 2B branch `feature/sprint-02b-dashboard-kpis-conjunto` · Inicio REAL 24-05-2026 21:25 · **v0.2.8 (pendiente bump)** · **PR #13 MERGEADO a developer 25-05-2026 07:27 UTC (merge commit `17b2902`)** · 7/7 phases 🟢 (phase-01..06 + CLOSE-5) · 193/193 tests Vitest verdes · 15/15 Playwright verdes (7 smoke + 8 deep checks) · CLOSE-1 🟢 · CLOSE-2 🟢 · CLOSE-4 🟢 (3 bugs resueltos) · CLOSE-5 🔵 Subida rama (PR #13) · E2E VPS 🟡 En curso (autodeploy ~2-3min) · ⏱ ~2h 08min push real vs 16h 30min estim (ratio −87%) · Pendiente: E2E VPS verde → bump v0.2.8 + tag + release notes + hand-off SP-4B phase-03b"
...
| ▸ Cierre Sprint 2B (SP-3B-CLOSE-1..5) | 🔵 Subida rama   | **4h 30min + bugs** | 15min     | —         | PR #13 MERGEADO a developer (merge commit `17b2902`, 25-05-2026 07:27 UTC) · Sigue [Protocolo estándar de cierre](#protocolo-estándar-de-cierre-de-sprint-close-1-5--paso-6-condicional) · CLOSE-3 **DIFERIDO a SP-4B phase-03b bloque 4** (Renzo) · paso 7 E2E VPS en curso (autodeploy) · paso 8 hand-off SP-4B pendiente                                                                                   |
...
| **Estado del sprint**          | 🔵 PR #13 MERGEADO a developer 25-05-2026 07:27 UTC (merge `17b2902`) · pendiente E2E VPS + bump v0.2.8 + hand-off SP-4B     |
...
| **Horas reales hasta ahora**   | ~1h 25min real vs 16h 30min estim (ratio −91%)                                                                               |
...
| **Phase 07** Cierre                | CLOSE-5: PR a developer + bump v0.2.8 + hand-off SP-4B phase-03b       | 4h 30min  | 🔵 Subida rama | 15min     | —         | PR #13    | PR #13 MERGEADO a developer (merge commit `17b2902`) · pendiente bump v0.2.8 + tag + release notes + hand-off SP-4B     |
| **E2E VPS**                        | Playwright contra dev.automatizaformacion.com post-merge               | —         | 🟡 En curso    | —         | —         | —         | Autodeploy VPS en curso (~2-3min tras merge 07:27 UTC) · spec listo: tests/e2e/sprint-2b-close/overview-section.spec.ts |
| **Subtotal Sprint 2B**             |                                                                        | ~16h30min |                | ~2h 08min | ~1h 53min |           | ~2h 08min push (1h 53min dev + 15min CLOSE-5) vs 16h 30min estim (ratio −87%) · Cierre pendiente bump+E2E VPS           |
...
| **Subtotal Fase 3 — Desarrollo** |                                                                                                                                                                        | **93-123h**         |              | Objetivo base 99h (+4h vs antes por SP-4-NODE-22). + 8h cierre phase-07. Total 101-131h con cierre. Histórico: -21h tras mover 4-04 + parte 4-03 al Sprint Costes-LLM post-MVP (22-05-2026); +4-6h tras añadir SP-4-NODE-22 (24-05-2026)                                |
