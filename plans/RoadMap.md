...
last_updated: 22-05-2026 19:30
last_updated_by: Javi HP (cierre formal Sprint 0 → 🟢 v0.1.0 — CHANGELOG.md creado, 2 lint fixes en CLOSE-4 (ThemeToggle:25 react-hooks + compliance.ts:104 prefer-const), CLOSE-1..5 a 🟢, tareas dev 1-01..1-27 a 🟢 excepto 1-03/1-05 diferidas pre-deploy VPS)
project_version: v0.1.0
sprint_0_progress: "✅ **Released v0.1.0 — Sprint 0 cerrado 22-05-2026** · Tag `v0.1.0` en commit `a387dfe` (merge PR #2) · DEV a 🟢: 0-00, 0-01, 1-01, 1-02, 1-04, 1-06, 1-07..1-27 (26 tareas locales). 1-03, 1-05 → 🟡 diferidas 100% VPS pre-deploy staging. Cierre completo: CLOSE-1 🟢 (~30min, DONE_WITH_CONCERNS aceptado: lint 118 errores preexistentes vs baseline 164 → -46), CLOSE-2 🟢 (~45min, 24/24 E2E + 5 WCAG findings + 2 bugs corregidos), CLOSE-3 🟢 (~1h 30min, análisis Bea+Renzo V1), CLOSE-4 🟢 (~25min, 2 bugs + 2 lint fixes), CLOSE-5 🟢 (~45min, CHANGELOG + RoadMap update + PR). ⏱ **Total Sprint 0: ~11h 5min vs 118h estimadas (-91%)**."
...
| ----------------------------------------------------------- | -------- | ----------------------- | --------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 👤 **SP-4B — Sprint Validación Pre-MVP**                    | `v0.4.0` | 04-08-2026 → 14-08-2026 | 40-55h          | 🔘 Pendiente | QA en VPS de los Sprints 0+1+2+2B+3. Re-test automático + E2C local + E2E VPS + **manual humano absorbido de CLOSE-3 de cada sprint MVP**. Bumpea SemVer a v0.4.0 GA. Detalle: [`plans/260522-1700-sprint-validacion-pre-mvp/plan.md`](260522-1700-sprint-validacion-pre-mvp/plan.md)                           |
...
| Sprints planificados                                                     | 10 + 1 dashboard KPIs MVP (SP-3B v0.3.5) + 1 validación pre-MVP (SP-4B v0.4.0 GA) + 1 costes-LLM (v0.5.1) + 1 refinamiento herramientas (v0.5.2)                                 |
...
| ----------------------------------------- | ------------- | --------------- | -------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 0**                           | 🟢 Completada | 118h            | 11h 5min | 22-05-2026 17:29 | ✅ v0.1.0 released · `feature/sp-0-sprint-0-hotfixes` mergeada en `developer` (PR #2, tag `v0.1.0`) · 26/27 dev tareas 🟢 · 1-03/1-05 🟡 diferidas pre-deploy VPS · CLOSE-1..5 todas 🟢 · CHANGELOG.md publicado                                                       |
...
| ▸ Cierre Sprint 0 (SP-1-CLOSE-1..5)       | 🟢 Completada | 5h 30min + bugs | 3h 35min | 22-05-2026 19:30 | CLOSE-1 🟢 ~30min (DONE_WITH_CONCERNS aceptado, lint 118 err preexistentes) · CLOSE-2 🟢 ~45min (24/24 E2E + 2 bugs corregidos) · CLOSE-3 🟢 ~1h 30min (análisis Bea+Renzo) · CLOSE-4 🟢 ~25min (2 bugs + 2 lint fixes) · CLOSE-5 🟢 ~45min (CHANGELOG + RoadMap + PR) |

### Sprint 1 — Capa de datos (sin ORM nuevo)

| Item                                                 | Estado       | Estim.              | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                            |
| ---------------------------------------------------- | ------------ | ------------------- | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 1**                                      | 🔘 Pendiente | **~205h**           | —      | —        | v0.2.0 · `feature/sprint-01-capa-datos` · Inicio Lun 08-06-2026 (+1 día por carga Sprint 0 hand-off) · +4 tareas NEW de docs Bea+Renzo (NEW-01, 02, 06, 13) +28h                                                                                                                 |
...
| ▸ **Bloque 2.9 — Fix bugs Renzo + reqs Bea (NUEVO)** | 🔘           | **28h**             | —      | —        | 0/4 · **NEW-01** Fix saveOrchestratorConfig + consolidación tablas orchestrator (8h) · **NEW-02** Enum unificado estados lead/cualificación (6h) · **NEW-06** Modelo oportunidades múltiples + dedup (10h) · **NEW-13** Política handoff unificada nº inválido→ilocalizable (4h) |
| ▸ Cierre Sprint 1 (SP-2-CLOSE-1..5)                  | 🔘           | **4h 30min + bugs** | —      | —        | CLOSE-3 (manual del dev) **DIFERIDO a SP-4B phase-02 bloque 4** · CLOSE-1/2/4/5 sin cambios                                                                                                                                                                                      |

### Sprint 2 — Adapter HubSpot + Zoho (MVP)

| Item                                           | Estado       | Estim.              | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------------------- | ------------ | ------------------- | ------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 2**                                | 🔘 Pendiente | **~169h**           | —      | —        | v0.3.0 · `feature/sprint-02-adapter-hubspot-zoho` · Inicio Lun 06-07-2026 (+3 días por extensión Sprint 1) · +4 NEW tareas docs Bea+Renzo (NEW-03, 05, 07, 08) +21h                                                                                                                                                                                                         |
| ▸ Tareas de desarrollo (Fase 2)                | 🔘           | 148h                | —      | —        | 0/7 (3-01..3-07) — sin sub-bloques                                                                                                                                                                                                                                                                                                                                          |
| ▸ **Bloque 3.B — Fix bugs + reqs Bea (NUEVO)** | 🔘           | **21h**             | —      | —        | 0/4 · **NEW-03** Fix Voice Agents (gpt-4o-mini correct + historial Retell + warning multi-estados) (4h) · **NEW-05** Widget switch TODOS/cualificados a CRM cliente + auto-purga no cualificados (6h) · **NEW-07** Inbox apagar bot ventana configurable + re-encendido lee humano (5h) · **NEW-08** Round Robin avanzado país+curso+origen + opción agenda compartida (6h) |
| ▸ Cierre Sprint 2 (SP-3-CLOSE-1..5)            | 🔘           | **4h 30min + bugs** | —      | —        | CLOSE-3 **DIFERIDO a SP-4B phase-03 bloque 4** · CLOSE-1/2/4/5 sin cambios                                                                                                                                                                                                                                                                                                  |

### Sprint 2B — Dashboard KPIs conjunto (NUEVO, MVP)

| Item                                  | Estado       | Estim.              | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                                                                     |
| ------------------------------------- | ------------ | ------------------- | ------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 2B**                      | 🔘 Pendiente | **16-24h + cierre** | —      | —        | **v0.3.5** · `feature/sprint-02b-dashboard-kpis-conjunto` · Inicio Lun 27-07-2026 · creado 22-05-2026 por requerimiento Bea: dashboard KPIs agregado (llamada+whatsapp+web) configurable. Detalle: [`plans/260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md`](260522-1800-sprint-2b-dashboard-kpis-conjunto/plan.md) |
...
| ▸ Cierre Sprint 2B (SP-3B-CLOSE-1..5) | 🔘           | **4h 30min + bugs** | —      | —        | CLOSE-3 **DIFERIDO a SP-4B phase-03 bloque 4** (junto a Sprint 2)                                                                                                                                                                                                                                                         |

### Sprint 3 — Hardening (cierre release candidate v0.4.0-rc.1)

| Item                                           | Estado       | Estim.        | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                                                                                                                               |
| ---------------------------------------------- | ------------ | ------------- | ------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **🚀 Sprint 3**                                | 🔘 Pendiente | **~112-140h** | —      | —        | **v0.4.0-rc.1** (release candidate) · `feature/sprint-03-hardening` · Inicio Vie 31-07-2026 (+8 días por Sprint 1 +28h, Sprint 2 +21h, Sprint 2B nuevo) · +4 NEW tareas docs Bea+Renzo (NEW-09, 10, 11, 12) +23h                                                                                                                    |
...
| ▸ Cierre Sprint 3 (SP-4-CLOSE-1..5)            | 🔘           | **7h + bugs** | —      | —        | CLOSE-3 **DIFERIDO a SP-4B phase-04 bloque 4** · CLOSE-5 incluye hand-off a SP-4B phase-04 + bump v0.4.0-rc.1 + crear rama feature/sprint-03b-validacion-pre-mvp para Renzo                                                                                                                                                         |

### 👤 Sprint Validación Pre-MVP — Equipo Renzo (entre Hardening y Sheets, cierre MVP v0.4.0 GA)

| Item                                     | Estado       | Estim.       | ⏱ Push | ⏱ Cierre | Notas                                                                                                                                                                                                                            |
| ---------------------------------------- | ------------ | ------------ | ------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 👤 **🚀 Sprint Validación Pre-MVP**      | 🔘 Pendiente | **40-55h**   | —      | —        | **v0.4.0 GA** · `feature/sprint-03b-validacion-pre-mvp` · Inicio Mar 04-08-2026 (post-Sprint 3 merge) · **Asignado a Renzo + equipo Renzo** · estim. recalculada 22-05-2026 por absorber CLOSE-3 manuales de Sprints 1, 2, 2B, 3 |
...
| 👤 ▸ Cierre SP-4B (CLOSE-1..5)           | 🔘           | 6-12h + bugs | —      | —        | Re-run consolidado + bump SemVer **v0.4.0 GA** · NO promociona a staging (requiere orden Javi HP)                                                                                                                                |
...
| 👤 ▸ Cierre Sprint Refinamiento (SP-5C-CLOSE-1..5) | 🔘           | **4h 30min + bugs** | —      | —        | CLOSE-3 manual ABSORBIDO por Renzo en este sprint (no diferido porque ya es Renzo) · CLOSE-1/2/4/5 estándar                                                                                                                                                                                                                                                                                 |
...
| ---- | -------------------------------------------------------------------------------------- | ---------- | ------------- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0-00 | Setup Playwright local + baseline tests E2E (devDependency `@playwright/test`)         | 4h         | 🟢 Completada | DA-5 pre-requisito | ⏱ Real (a push): 45min · ✅ Commit `00cc35a` 21-05-2026 — config chromium + smoke spec + 5 scripts npm                                                                                                                 |
| 0-01 | Setup pre-push hooks (Husky/lefthook) — typecheck + lint + test + build en local       | 3h         | 🟢 Completada | Política operativa | ⏱ Real (a push): 1h · ✅ Commit `a74406e` 21-05-2026 — husky + lint-staged + commit-msg + bonus 3 fixes typecheck                                                                                                      |
| 1-01 | Fix `worker.js:58` firma incorrecta `executeSequenceStep` — desbloquea flujo multi-día | 4h         | 🟢 Completada | F-02-001 / DA-1    | ⏱ Real (a push): 30min · ✅ Commit `847ef79` — worker carga lead+config+sequence antes de llamar con firma `(lead, tenantId, sequence, stepIndex, config)`. typecheck+build OK. Test multi-día diferido a SP-1-CLOSE-2 |
| 1-02 | Fix `enqueueLeadStep` — quitar silenciado errores Redis (jobs perdidos sin log)        | 3h         | 🟢 Completada | DA-1-005           | ⏱ Real (a push): 25min · ✅ Commit `662073f` — catch silencioso reemplazado por log estructurado (sin PII) + re-throw. Sin ID ficticio. 3 callers ya manejan throw. typecheck+build OK                                 |
...
| 1-04 | Quitar JWTs hardcodeados de 10 puntos del código fuente                 | 6h         | 🟢 Completada              | F-04-002 / DA-2 | ⏱ Real (a push): 50min · ✅ Commit `d595287` — helper `src/lib/env.ts` (requireEnv/requireEnvAny) + refactor 5 archivos. `grep eyJhbGci\|FALLBACK_ src/` = 0                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 1-06 | Crear usuario Postgres `app_user` con permisos limitados (no superuser) | 3h         | 🟢 Completada              | R-023.a         | ⏱ Real (a push): 40min · ✅ SQL `supabase/scripts/create-app-user.sql` idempotente + README. 🟢 **Apply local OK** (rol creado vía `docker exec postgres psql -U postgres`, 3 verificaciones OK: rol sin privilegios elevados / 4 permisos DML / 0 DDL). Password en `.env.local` como `APP_USER_PASSWORD`. 🟡 Apply VPS diferido pre-staging. Worker.js NO usa pg directo → 3h sin +1h. **Ajuste técnico:** removido `NOSUPERUSER/NOREPLICATION/NOBYPASSRLS` del ALTER (sólo superuser real puede setear esos; CREATE ROLE defaults ya los excluyen) |

#### Bloque 1.3 — Endpoints sin autenticación

| ID   | Tarea                                                                                        | Estimación | Estado        | Refs audit          | Notas                                                                                                                                                           |
| ---- | -------------------------------------------------------------------------------------------- | ---------- | ------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1-07 | Auth en endpoints orquestación user-driven (deploy, graph, publish, workflows, calls/manual) | 8h         | 🟢 Completada | DA-2-001            | ⏱ Real (a push): 25min · helper `src/lib/api-auth.ts` (requireApiUser + requireTenantAccess) · graph verifica ownership vía `data.tenant_id` · commit `4da79b1` |
| 1-08 | Auth en cron endpoints (sweep + cron/appointments/reminders)                                 | 4h         | 🟢 Completada | DA-3-001 / DA-3-007 | ⏱ Real (a push): 10min · `requireCronSecret` timing-safe + `CRON_SECRET` añadido a `.env.example` · commit `4da79b1`                                            |
| 1-09 | Guard condicional `tenants.config.test_orchestrator_enabled` (DENY by default)               | 2h         | 🟢 Completada | DA-3-003            | ⏱ Real (a push): 10min · `requireOrchestrationEnabled` aplicado a deploy/publish/workflows POST/calls/manual · TEMPORAL — eliminar en Fase 3 · commit `4da79b1` |
| 1-10 | Cerrar `/api/admin/tenants/[id]/client-sql` (descarga SQL config sin auth)                   | 2h         | 🟢 Completada | DA-2-002            | ⏱ Real (a push): 5min · `requireApiAdmin` añadido al GET · commit `4da79b1`                                                                                     |
| 1-11 | Cerrar `/api/tenant/migrate` GET (sirve MIGRATION_SQL completo) + POST user-auth             | 1h         | 🟢 Completada | DA-2-003            | ⏱ Real (a push): 5min · GET → `requireApiAdmin`, POST → `requireApiUser` (SSRF cerrado en 1-22) · commit `4da79b1`                                              |

#### Bloque 1.4 — Webhooks y firmas

| ID   | Tarea                                                      | Estimación | Estado        | Refs audit | Notas                                                                                                                                                                                          |
| ---- | ---------------------------------------------------------- | ---------- | ------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1-12 | Validación firma webhook Retell                            | 4h         | 🟢 Completada | DA-4-001   | ⏱ Real (a push): 8min · `verifyHmacSignature` + `verifyRetellWebhook` lee `x-retell-signature` y `RETELL_WEBHOOK_SECRET` env · commit `a17c687`                                                |
| 1-13 | Validación firma Retell **tools** (cancelar/agendar citas) | 6h         | 🟢 Completada | DA-2-007   | ⏱ Real (a push): 5min · mismo helper que 1-12 · el más peligroso sin auth · commit `a17c687`                                                                                                   |
| 1-14 | Validación HMAC WhatsApp obligatoria (no condicional)      | 2h         | 🟢 Completada | DA-2-006   | ⏱ Real (a push): 7min · `WHATSAPP_APP_SECRET` ahora obligatorio · `WHATSAPP_VERIFY_TOKEN` movido a env (antes hardcoded) · commit `a17c687`                                                    |
| 1-15 | Validación firma webhook CRM (anti tenant_id spoofing)     | 6h         | 🟢 Completada | DA-2-009   | ⏱ Real (a push): 8min · `verifyCrmWebhookSignature` con secret per-tenant (`tenants.config.webhook_crm_secret`) · firma del header `x-webhook-signature` atada al tenant_id · commit `a17c687` |

#### Bloque 1.5 — Privilege escalation y RLS

| ID   | Tarea                                                                               | Estimación | Estado　　　  | Refs audit       | Notas                                                                                                                                                                                                                                                                                  |
| ---- | ----------------------------------------------------------------------------------- | ---------- | ------------- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1-16 | Fix privilege escalation via `user_metadata.is_admin` editable por usuario          | 4h         | 🟢 Completada | DA-2-005         | ⏱ Real (a push): 10min · middleware.ts/auth.ts/api-auth.ts/tenant.ts leen+escriben `is_admin` SOLO en `app_metadata` · script `supabase/scripts/migrate-is-admin-to-app-metadata.sql` aplicado en local (1 user migrado) · commit `da64297`                                            |
| 1-17 | Verificación rol admin en `createTenant`/`deleteTenant`/`updateTenant`/`getTenants` | 3h         | 🟢 Completada | DA-2-004         | ⏱ Real (a push): 6min · helper `assertAdminAccess()` añadido a las 4 server actions · commit `da64297`                                                                                                                                                                                 |
| 1-18 | Fix RLS tabla `tenants` (quitar policy tautológica `USING(true)`)                   | 3h         | 🟢 Completada | DA-2-010         | ⏱ Real (a push): 8min · migration `20260521000000_rls_tenants_hardening.sql` · SELECT por `auth_user_id`+admin / IUD solo admin · **aplicada en local** (4 CREATE POLICY OK) · 🟡 VPS pre-deploy · commit `da64297`                                                                    |
| 1-19 | Fix RLS `knowledge_base` (quitar `app.current_tenant` dead letter — nunca se setea) | 2h         | 🟢 Completada | F-04-004         | ⏱ Real (a push): 7min · migration `20260521000001_rls_knowledge_base_hardening.sql` · 4 policies (S/I/U/D) ownership-based · **aplicada en local** · 🟡 VPS pre-deploy · commit `da64297`                                                                                              |
| 1-20 | Fix `fetchCalls` — añadir filtro `tenant_id` en 4 funciones                         | 4h         | 🟢 Completada | F-04-001 / DA-2  | ⏱ Real (a push): 6min · fetchCalls/getCallsByPhone/fetchIntentosByPhone/fetchWhatsappByPhone usan `getActiveTenantId` + `.eq("tenant_id", id)` · sin tenant → resultado vacío · commit `da64297`                                                                                       |
| 1-21 | Fix IDOR `inbox.ts` 9 funciones — verificar ownership tenant                        | 8h         | 🟢 Completada | DA-2 inbox sweep | ⏱ Real (a push): 13min · updateLeadSegment/sendManualMessage/injectMockupMessage/toggleLeadAI/assignAgentToLead/deleteLead/deleteChatHistory/deleteLeadFacts/updateLeadInfo · todas con `.eq("tenant_id", tenant.id)` + updateLeadInfo filtra tenant_id del payload · commit `da64297` |

#### Bloque 1.6 — Otros críticos

| ID                               | Tarea                                                                                                                                           | Estimación      | Estado        | Refs audit                                                                                                                                 | Notas                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1-22                             | Fix SSRF `/api/tenant/migrate` cookie `af-tenant-url` (añadir allowlist)                                                                        | 8h              | 🟢 Completada | DA-3-002                                                                                                                                   | ⏱ Real (a push): 12min · URL+key del Supabase del tenant resueltas DESDE DB (no de cookie) usando `esden-tenant-id` · gate `requireApiAdmin` · `isAllowedTenantUrl()` bloquea loopback/RFC1918 (override en dev con `ALLOW_INTERNAL_TENANT_URLS=true`) · commit `2c9437c`                                                                                                                                                                                                                                                                                                                                              |
| 1-23                             | Sanitización XSS widget embed (interpolación `id` en JS servido a terceros)                                                                     | 4h              | 🟢 Completada | DA-3-004                                                                                                                                   | ⏱ Real (a push): 4min · validación regex UUID estricta antes de interpolar · `id`+`baseUrl` inyectados vía `JSON.stringify` (corte de escape imposible) · 400 si formato inválido · commit `2c9437c`                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 1-24                             | Update `axios@1.14.0` → `axios@1.16.1` (15 CVEs: SSRF + Prototype Pollution)                                                                    | 4h              | 🟢 Completada | DA-3-CVE-001                                                                                                                               | ⏱ Real (a push): 8min · ADR-2026-05-20 ya aprobado · `npm install` OK · ajuste tipos `AxiosHeaderValue` en WhatsAppWebhookProcessor (content-type normalizado a string\|undefined) · commit `2c9437c`                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 1-25                             | Reemplazar paquete `crypto@1.0.1` DEPRECATED por built-in `node:crypto`                                                                         | 3h              | 🟢 Completada | ADR-2026-05-20                                                                                                                             | ⏱ Real (a push): 3min · grep `from 'crypto'` en src/ + worker.js = 0 ocurrencias · paquete removido limpio de `package.json` · helpers HMAC ya usan `node:crypto` explícito · commit `2c9437c`                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 1-26                             | Update `next@16.1.6` → `next@16.2.6` (cierre 19 CVEs incl. middleware bypass)                                                                   | 4h              | 🟢 Completada | DA-3-CVE-002                                                                                                                               | ⏱ Real (a push): 30min · ✅ Commit `1ce8e0b` 21-05-2026 — `next@16.2.6` + `eslint-config-next@16.2.6` + ADR-002 documentado. typecheck/build limpios. Smoke test diferido a SP-1-CLOSE-2                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 1-27                             | **Widget Chatbot Server Action — `web_widgets.allowed_domains` + rate limit + Origin/Referer check** (cierra API abierta sin CORS/whitelisting) | 8h              | 🟢 Completada | Informe Renzo §3 🔴                                                                                                                        | ⏱ Real (a push): 1h 15min · Migración `20260522000000_widget_hardening_allowed_domains_rate_limit.sql` (allowed_domains text[], rate_limit_per_minute int, CHECK constraint) **aplicada en local** · helpers `src/lib/api/validate-widget-origin.ts` (wildcards + modo legacy) y `src/lib/api/rate-limit-widget.ts` (sliding window Redis con `lazyConnect` + fallback ALLOW si Redis caído) · `widget.ts:getChatbotResponse` aplica guards al inicio · `WebWidget` type extendido · typecheck/lint/build OK (0 errores nuevos). Fuente: `docs/Informes de programacion/Reporte-Modulo-Chatbot-Web-Renzo-V1.pdf` §3 🔴 |
| **Subtotal Fase 0 — Desarrollo** |                                                                                                                                                 | **~112h 30min** |               | (incluye 0-00 Playwright setup 4h + 1-27 widget hardening 8h) · DEV completado a 🟢: ⏱ Real ~7h 30min · 1-03/1-05 diferidas pre-deploy VPS |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| SP-1-CLOSE-4                 | **Corrección de Bugs y cambios detectados** — Subtareas dinámicas: una por cada bug/cambio que reporte el dev. Cada subtarea con su propio estado.                                                                                                                                                        | (variable)                     | 🟢 Completada                               | ⏱ Real (final): ~25min · 2 bugs CLOSE-2 cerrados (commit `8beeddd`): BUG-001 logout → `auth.ts:108` `redirect('/login')`, BUG-002 viewer→admin → `middleware.ts:65` extiende guard a `/admin` · 2 lint fixes en cierre formal: `ThemeToggle.tsx:25` eslint-disable react-hooks/set-state-in-effect justificado (hydration-safe mount) + `compliance.ts:104` `let startH` → `const` · CLOSE-3 sin bugs (reemplazado por análisis docs Bea+Renzo, output a SP-4B)                                                                                                                                                |
| SP-1-CLOSE-5                 | **Cierre de Sprint** — PR `feature/sp-0-sprint-0-hotfixes` → `developer`. Tras merge: bump SemVer a `v0.1.0`, invitar al dev a tomar siguiente sprint, crear rama `feature/sprint-01-capa-datos`. **Incluye hand-off a SP-4B phase-01** ✅ ya hecho (plantilla rellenada en commit de creación de SP-4B). | 1h                             | 🟢 Completada                               | ⏱ Real (final): ~45min · ✅ PR #2 mergeada en `developer` commit `a387dfe` el 22-05-2026 17:29 · ✅ Tag `v0.1.0` creado por Renzo en `a387dfe` el 22-05-2026 17:29:50 · ✅ `package.json` ya en `0.1.0` (heredado del codebase) · ✅ rama `feature/sprint-01-capa-datos` creada y Sprint 1 kickoff (`4b43b78`) · ✅ hand-off SP-4B phase-01 entregado · ✅ CHANGELOG.md publicado en cierre formal · ✅ RoadMap actualizado (esta tarea) · PR cierre formal: `feature/sp-0-close-formal` → `developer`                                                                                                         |
| **Subtotal cierre Sprint 0** |                                                                                                                                                                                                                                                                                                           | **5h 30min + Corrección bugs** | ⏱ Real: **~3h 35min**                       | CLOSE-1..5 todas 🟢 · Total Sprint 0 (dev + cierre): ~11h 5min vs 118h estimadas (−91%)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
- [x] `SP-1-CLOSE-1` Auto test 🟢 — DONE_WITH_CONCERNS aceptado (lint debt preexistente diferida a Sprint 1, typecheck+build 0 errores).
- [x] `SP-1-CLOSE-2` E2C Local 🟢 — 24/24 E2E PASS, 5 WCAG findings absorbidos por SP-4B phase-01.
...
- [x] `SP-1-CLOSE-4` Bugs detectados 🟢 — 2 bugs CLOSE-2 + 2 lint fixes cierre formal, sin subtareas abiertas.
...
| ~~SP-2-CLOSE-3~~             | ~~Test Manual del Dev~~ — **DIFERIDO a 👤 SP-4B phase-02 bloque 4** (Renzo + equipo). El hand-off en SP-2-CLOSE-5 rellena la plantilla. | (0h aquí)           | 🟢 Diferida  | Decisión 22-05-2026. Hand-off documentado en SP-2-CLOSE-5 |
| SP-2-CLOSE-4                 | Corrección de Bugs detectados                                                                                                           | (variable)          | 🔘 Pendiente | Subtareas dinámicas                                       |
| SP-2-CLOSE-5                 | Cierre de Sprint → PR a `developer` + bump a `v0.2.0` + crear rama Sprint 2 + **hand-off a SP-4B phase-02** (rellenar plantilla)        | 1h                  | 🔘 Pendiente | Hand-off obligatorio antes de cerrar                      |
...
| ~~SP-4-CLOSE-3~~             | ~~Test Manual del Dev~~ — **DIFERIDO a 👤 SP-4B phase-04 bloque 4** (Renzo + equipo) — el más extenso (cierre release candidate v0.4.0-rc.1)                                   | (0h aquí)           | 🟢 Diferida  | Decisión 22-05-2026                                                     |
| SP-4-CLOSE-4                 | Corrección de Bugs detectados                                                                                                                                                  | (variable)          | 🔘 Pendiente |                                                                         |
| SP-4-CLOSE-5                 | Cierre de Sprint → PR a `developer` + **bump a `v0.4.0-rc.1`** (release candidate) + hand-off a SP-4B phase-04 + crear rama `feature/sprint-03b-validacion-pre-mvp` para Renzo | 1h                  | 🔘 Pendiente | **NO es ya el MVP GA** — el bump a v0.4.0 lo hace SP-4B tras validación |
| **Subtotal cierre Sprint 3** |                                                                                                                                                                                | **8h 30min + bugs** |              |                                                                         |

---

## Fase 3.5 — Sprint Validación Pre-MVP (entre Hardening y Sheets, MVP v0.4.0 GA)

| Campo                          | Valor                                                                                           |
| ------------------------------ | ----------------------------------------------------------------------------------------------- |
| **Sprint ID**                  | `SP-4B`                                                                                         |
| **Versión objetivo al cierre** | `v0.4.0` (MVP GA — detonado por este sprint)                                                    |
| **Estado del sprint**          | 🔘 Pendiente                                                                                    |
...
| SP-4B-CLOSE-5             | PR `feature/sprint-03b-validacion-pre-mvp` → `developer` + bump **v0.4.0 GA** + tag + mensaje a Javi HP pidiendo orden promoción staging | 1h                  | 🔘     |
...
| -------------------------------- | ---------------- | ------------- | --------------------------------------------------------------------------- | ----------------------------------------------------- | ------------------------- |
| **Sprint 0** (Fase 0)            | v0.1.0           | 🟢 Completada | **27** (detalladas, +1-27 widget hardening) — 26 🟢 + 2 🟡 diferidas VPS    | ~112h 30min (real ~7h 30min)                          | 5h 30min (real ~3h 35min) |
