...
| ▸ Tareas de desarrollo                | 🟡 En Desarrollo | 16-24h              | —      | —        | 0/1 · **NEW-04** Dashboard KPIs conjunto · 7 phases · **24-05 21:25 START** · phase-01 🟢 (DEFAULT_OVERVIEW_KPIS + Zod schema + 10 tests verdes, ~15min) · phase-02..07 🔘 · Decisión R1: extender `/dashboard` zero-migration · 4 KPIs + 4 charts (funnel ✅, canal=2 valores+tooltip) + KPI Builder C                                                                                                       |
