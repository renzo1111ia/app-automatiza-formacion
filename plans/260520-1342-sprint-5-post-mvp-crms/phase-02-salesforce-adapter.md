...
version_bump: v0.5.1
agents: [esden-agents:code, esden-agents:api, esden-agents:adr]
---
...
- [ADR dependencias](../reports/adr-auditoria-dependencias-20260520.md) — sección Sprint 3/E jsforce
...
- **Estado**: Pendiente — bloqueado por Sprint 3 completado + ADR jsforce aprobado
...
- `jsforce@^3.10.15` NO instalado — requiere ADR antes de instalar (ejecutar `esden-agents:adr` primero)
...
1. **ADR**: ejecutar `esden-agents:adr` para aprobar `jsforce@^3.10.15` — verificar compatibilidad Node 24, Next 16, no peer deps críticas
...
- Bloqueado por: Sprint 3 completado + ADR jsforce aprobado
