...
## Nota sobre "cierre Sprint 5"

Sprint 5 es incremental — cada integración 5-01..5-04 tiene su propio PR y bump de versión. Por tanto, el "cierre de Sprint 5" se ejecuta cuando se considera que el conjunto de integraciones implementadas es suficiente para un hito (ej. las 4 integraciones + 5-05 completo).
