---
title: "Sprint 2 — Capa de datos (sin ORM nuevo)"
description: "Plan operativo Sprint 2: unificación Supabase, Zod schemas, Repository pattern, RLS hardening, updates ADR y hook automation."
status: pending
priority: P1
effort: 173h
...
> **Nota 2-27:** Movida a Sprint 1 como 1-26. Ver `plans/260520-1342-sprint-1-hotfixes-seguridad/phase-06-otros-criticos.md`.
...
## 2-35 — Sistema de 3 READMEs por rama (tarea adicional Sprint 2)
...
| Estado | Pendiente |
| Independencia | Puede ejecutarse en cualquier momento del Sprint 2 — sin dependencias de 2-01..2-34 |
...
- `.claude/hooks/esden-readme-sync-precommit.cjs` — pre-commit hook local
...
- Sprint 1: `plans/260520-1342-sprint-1-hotfixes-seguridad/`
