...
- **Prioridad:** P1
- **Estado:** Pendiente — requiere Fase 3 (repositorios) completa
...
- Sprint 1 identificó 9 fallbacks `service_role` en `src/lib/actions/` — 2-20 debe eliminarlos todos
- 2-21 es continuación de 1-01 (refactor worker queries) — verificar qué quedó pendiente de Sprint 1
...
3. **2-21 — Refactor worker.js + processors (4h)**
   ...
   - Verificar qué quedó pendiente de 1-01 (Sprint 1)
...
- **Responsable:** `esden-agents:code` (2-19 y 2-20) + `esden-agents:database` (2-21)
- **Revisión:** `esden-agents:security`

## Next Steps

- Paralelizable con Fase 5 (type safety) — tocan archivos distintos
