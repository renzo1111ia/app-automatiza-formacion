...
- ADR: `plans/reports/adr-auditoria-dependencias-20260520.md` §Sprint 2 (supabase/ssr upgrade)
...
4. **2-03 — Eliminar service_role residuales (3h)**
   ...
   - Continuación directa de 1-04 (Sprint 1)
...
- **Revisión:** `esden-agents:security` (verificar 0 service_role residuales)

## Next Steps

- Fase 2 (Zod) puede empezar en paralelo desde día 1
- Fase 3 (Repository pattern) requiere esta fase completa
