...
- **Estado**: Pendiente — bloqueado por Sprint 2 + registro app GHL Marketplace
...
- Bloqueado por: Sprint 2 completado + app GHL Marketplace aprobada
