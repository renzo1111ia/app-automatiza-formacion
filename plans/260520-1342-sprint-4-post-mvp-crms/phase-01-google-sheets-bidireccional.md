...
- [ADR dependencias](../reports/adr-auditoria-dependencias-20260520.md) — sección Sprint 4 Sheets
...
- **Estado**: Pendiente — bloqueado por Sprint 2 completado
...
- Bloqueado por: Sprint 2 completado (IntegrationAdapter base)
