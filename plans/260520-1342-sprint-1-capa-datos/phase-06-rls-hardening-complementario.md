...
> **2-27 MOVIDA:** `next@16.1.6 → 16.2.6` fue movida a Sprint 0 como tarea 1-26 dado el CVSS 8.6 (SSRF via WebSocket) y 8.1 (middleware bypass) near-critical para sistema multi-tenant. Ver `plans/260520-1342-sprint-0-hotfixes-seguridad/`. Las 6h de su estimación se restan del total Sprint 1.

## Overview

- **Prioridad:** P1 (2-23..2-25), P2 (2-26)
- **Estado:** Pendiente — paralelizable con todo. No depende de Fases 01-05.
- **Descripción:** Corregir las 3 políticas RLS tautológicas/incompletas detectadas en audit (ai_agents, web_widgets, programs). Implementar cifrado de Google OAuth tokens (aplazado desde Sprint 0).
...
- 2-27 está en Sprint 0 — NO incluir aquí. Marcar como referencia únicamente.
...
5. **2-27 — MOVIDA A SPRINT 1 (1-26)**
   - ✅ next@16.1.6 → 16.2.6 movida a Sprint 0 como 1-26 por CVSS 8.6/8.1 near-critical
   - Ver `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-06-otros-criticos.md`
   - Estimación de 6h excluida del total Sprint 1
...
- 2-26: implementar rotación de clave de cifrado como parte del diseño (aunque no se use en Sprint 1)

## Agente Esden

- **Responsable:** `af-agents:database` (2-23..2-25) + `af-agents:security` (2-26)
- **Revisión:** `af-agents:security` (test anti-fuga todos los fixes)
