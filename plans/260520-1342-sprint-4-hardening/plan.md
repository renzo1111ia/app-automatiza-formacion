---
title: "Sprint 4 — Hardening (v0.4.0 MVP completo)"
...
> Ref: [RoadMap.md — Fase 4](../RoadMap.md#fase-4--sprint-4-hardening) · [DEEP-FINDINGS-SUMMARY.md](../../docs/audit/deep/DEEP-FINDINGS-SUMMARY.md) · [DA-5-accessibility.md](../../docs/audit/deep/DA-5-accessibility.md)

**Prerequisito:** Sprint 3 completo (MVP HubSpot + Zoho funcional). Sprint 4 comienza desde `v0.3.0`.
...
```
PREREQUISITO GLOBAL:
  Sprint 3 COMPLETO (v0.3.0) → Todas las fases D
...
|----------------|----------------------|
| Sprint 1 (SP-1-CLOSE-2) | Playwright setup base (si se instaló en Sprint 1) |
| Sprint 2 (2-30, 2-31) | Componentes shadcn actualizados (WCAG aprovecha) |
| Sprint 2 (2-14..2-18) | Repository pattern (coverage targets aprovecha repos) |
| Sprint 3 | Multi-LLM pipeline existente (dashboard costes usa callbacks) |
...
| CSP `unsafe-inline` necesario para Tailwind rompe política strict | Media | Medio | Aceptar compromiso `unsafe-inline` styles para MVP; strict-dynamic en Sprint 5 |
...
- Sprint 1: `plans/260520-1342-sprint-1-hotfixes-seguridad/plan.md`
- Sprint 2: `plans/260520-1342-sprint-2-capa-datos/plan.md`
