# Reporte: Plan operativo Sprint 0 — Hotfixes de seguridad

**Fecha:** 20-05-2026
**Autor:** planner
**Plan creado:** `plans/260520-1342-sprint-0-hotfixes-seguridad/`

---

## Resumen de lo planificado

Plan operativo completo del Sprint 0 (Fase 0 del RoadMap). Cubre las 24 tareas de desarrollo (A-01 a A-24) + las 5 tareas de cierre (SP-A-CLOSE-1 a 5), organizadas en 7 fases.
...
|---------|-----------------|------------|
| `plans/260520-1342-sprint-0-hotfixes-seguridad/plan.md` | Overview + dependencias + criterios éxito | — |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-01-orquestador-bullmq.md` | A-01, A-02 | 7h |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-02-secretos-y-credenciales.md` | A-03, A-04, A-05, A-06 | 12h |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-03-endpoints-sin-auth.md` | A-07, A-08, A-09, A-10, A-11 | 15h 30min |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-04-webhooks-y-firmas.md` | A-12, A-13, A-14, A-15 | 16h |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-05-privilege-escalation-rls.md` | A-16, A-17, A-18, A-19, A-20, A-21 | 24h |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-06-otros-criticos.md` | A-22, A-23, A-24 | 14h |
| `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-07-cierre-sprint.md` | SP-A-CLOSE-1..5 | 5h 30min + bugs |
...
### 5. A-24 (axios) pasa por af-agents:adr obligatoriamente
El hook `af-deps-guard.cjs` bloquea la instalación sin ADR aprobado. Delegar a `af-agents:adr` antes de intentar `npm install`.

---

## Solapes documentados con plan RLS existente

| Tarea Sprint 0 | Solape con plan RLS | Acción tomada en este plan |
|---|---|---|
