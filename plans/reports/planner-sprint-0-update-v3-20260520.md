# Planner Report — Sprint 0 Update v3

**Agente:** planner
**Fecha:** 20-05-2026
**Scope:** Incorporación de A-25 (crypto deprecated) y A-26 (next@16.2.6) al plan Sprint 0

---

## Cambios aplicados

### `plans/260520-1342-sprint-0-hotfixes-seguridad/plan.md`
...
- Nueva sección "Dependencias críticas entre tareas (v3)" con nota sobre 1-27 movida a A-26

### `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-06-otros-criticos.md`
...
### `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-03-endpoints-sin-auth.md`
...
### `plans/260520-1342-sprint-0-hotfixes-seguridad/phase-05-privilege-escalation-rls.md`
...
**1-27 en Sprint 1:** La tarea 1-27 del plan Sprint 1 (update next, 6h estimadas) queda marcada como "MOVIDA A A-26 — completada en Sprint 0". La estimación bajó de 6h a 4h porque se confirmó que es minor (no major) y no requiere upgrade de dependencias adicionales.

---

**Status:** DONE
**Summary:** Plan Sprint 0 actualizado a v3. Incorporadas A-25 (crypto deprecated, 3h) y A-26 (next@16.2.6, 4h) con dependencias completas, justificación técnica de CVEs, rollback plan explícito para A-26, y notas de pre-requisito en Ph3 y Ph5. Estimación total: ~106h 30min.
