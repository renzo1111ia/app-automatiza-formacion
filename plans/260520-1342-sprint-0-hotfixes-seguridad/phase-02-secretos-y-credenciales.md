...
**Agentes:** `af-agents:security` (1-03, 1-04, 1-05) + `af-agents:database` (1-06)
...
- 1-06: el script SQL de creación de `app_user` debe ser reutilizable en Fase 1 (guardarlo en `supabase/scripts/`).
...
-- Reutilizable en Fase 1 para refactor completo de conexiones
...
6. Este script se reutiliza en Fase 1 (2-02) cuando se migre completamente a `@supabase/ssr` con el usuario correcto.
