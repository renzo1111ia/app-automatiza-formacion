...
- El CHANGELOG ya tiene entradas v0.1.0 (Sprint 0), v0.2.0 (Sprint 1), v0.3.0 (Sprint 2) — v0.4.0 cierra el ciclo
...
### Funcionales
- `CHANGELOG.md` entrada `## [v0.4.0]` con todos los cambios de Sprint 3 y resumen de MVP completo
...
Marcar Sprint 0 (v0.1.0), 2 (v0.2.0), 3 (v0.3.0), 4 (v0.4.0) como completados.
...
- [ ] CHANGELOG.md entrada v0.4.0 completa (con todos los items de Sprint 3)
...
- `CHANGELOG.md` tiene entrada `## [v0.4.0]` con todos los cambios de Sprint 3
...
- Con v0.4.0 etiquetado, el equipo puede discutir si arrancar Fase 4 (post-release) o hacer una pausa
