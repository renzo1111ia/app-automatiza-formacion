...
effort: 28-40h
status: pending
agents: [af-agents:uxui, af-agents:code]
---
...
- DA-5-012 responsive si no se incluye → crear tech debt item para Sprint 4
- Lighthouse score ≥ 90 como gate de calidad para el PR de cierre Sprint 3
