...
- Interface + adapters: `plans/260520-1342-sprint-3-adapter-hubspot-zoho/phase-01` a `phase-06`
...
- Datos de test: usar emails ficticios (`test-XXX@esden-sandbox.test`) para no contaminar sandbox con datos reales

## Agentes Esden asignados

- `esden-agents:testing` — toda la fase 3-07
...
- Phase 08 — Cierre Sprint 3
- Sprint 4 hardening: añadir estos tests al CI pipeline como smoke tests de integración
