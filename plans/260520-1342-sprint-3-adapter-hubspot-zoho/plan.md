---
title: "Sprint 3 — Adapter Layer + HubSpot + Zoho MVP"
description: "Plan operativo Sprint 3: IntegrationAdapter interface, HubSpot OAuth2 adapter, Zoho multi-DC adapter, field mapping, UI admin, audit log."
status: pending
priority: P1
effort: 104h
...
## Dependencias críticas de Sprint 2

Sprint 3 **no puede iniciar** hasta que estén completas:
...
| 8 | Cierre Sprint 3 | ~10h | Pendiente | [phase-08](phase-08-cierre-sprint.md) |
...
Día 1+
  ...
  3.4 field_mapping schema (solo tabla BD) ─────────────┤
                                                        │
Día 4+ (requiere 3.1 + deps Sprint 2)                   │
...
|--------|------|---------|-----------|
| Sprint 2 incompleto (2-18/2-26) bloquea inicio Sprint 3 | Media | Alto | Verificar estado Sprint 2 antes de iniciar Sprint 3; tareas 3.1+3.4 schema pueden avanzar sin 2.3 completo |
...
- Sprint 2 plan: `plans/260520-1342-sprint-2-capa-datos/plan.md`
