...
- Interface FieldMappingEntry: `plans/260520-1342-sprint-3-adapter-hubspot-zoho/phase-01-integration-adapter-interface.md`
- Sprint 2 2-11 (Zod schema integrations): `plans/260520-1342-sprint-2-capa-datos/phase-02-schemas-zod.md`
...
- `esden-agents:database` — migración BD + RLS + repository
- `esden-agents:code` — schemas Zod + resolver + integración adapters
