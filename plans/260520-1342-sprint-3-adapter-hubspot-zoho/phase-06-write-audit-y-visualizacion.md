...
- Field mapping + write_policy: `plans/260520-1342-sprint-3-adapter-hubspot-zoho/phase-04-field-mapping-write-policy.md`
- Interface AuditEntry: `plans/260520-1342-sprint-3-adapter-hubspot-zoho/phase-01-integration-adapter-interface.md`
- UI admin: `plans/260520-1342-sprint-3-adapter-hubspot-zoho/phase-05-ui-admin-conexion-crm.md`
...
| Volumen alto en futuro (>10k entradas) | Baja | Bajo | Índice en `(tenant_id, created_at DESC)` cubre el caso. Si crece: particionado por mes en Fase D |
...
- `esden-agents:database` — migración + repository
- `esden-agents:uxui` — tabla UI + tab
- `esden-agents:code` — integración en adapters
...
- Sprint 4: añadir alertas/dashboard de audit para supervisor
