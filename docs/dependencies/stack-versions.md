...
| Paquete | Declarada | Instalada | Latest-stable | Gap | Notas |
|---------|-----------|-----------|---------------|-----|-------|
| `@aws-sdk/client-bedrock-agent-runtime` | `^3.1031.0` | `3.1031.0` | `3.1048.0` | m | 17 patches; actualizar para fix fast-xml-parser CVE |
| `@aws-sdk/client-bedrock-runtime` | `^3.1031.0` | `3.1031.0` | `3.1048.0` | m | Idem |
| `@aws-sdk/client-s3` | `^3.1031.0` | `3.1031.0` | `3.1048.0` | m | Idem |
