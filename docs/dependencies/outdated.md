...
| `@aws-sdk/client-bedrock-agent-runtime` | 3.1031.0 | 3.1048.0 | 3.1048.0 | minor | **Medium** — CVE fast-xml-parser en transitiva |
| `@aws-sdk/client-bedrock-runtime` | 3.1031.0 | 3.1048.0 | 3.1048.0 | minor | **Medium** — Idem |
| `@aws-sdk/client-s3` | 3.1031.0 | 3.1048.0 | 3.1048.0 | minor | **Medium** — Idem |
...
### `@aws-sdk/*` 3.1031.0 → 3.1048.0 (minor — 17 patches)
**Impacto de NO actualizar**: Transitiva `fast-xml-parser` tiene CVE moderado; `fast-xml-builder` tiene CVE High. Las llamadas a Bedrock pueden procesar XML malicioso.

**Impacto de actualizar**: AWS SDK mantiene compatibilidad semver. Actualización segura.

**Recomendación**: Actualizar en bloque (`@aws-sdk/*`).
