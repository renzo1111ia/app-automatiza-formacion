...
// ─── OVERVIEW KPIs (Sprint 2B — cross-canal dashboard hero) ───────────────────

/**
 * 4 KPIs hero por defecto para la sección Overview de /dashboard.
 * Cross-canal (llamadas + whatsapp + web consolidados via getKpiOverview()).
 * Persistencia: tenants.config.overview_kpis JSONB. Zero-migration.
...
export const DEFAULT_CHARTS: ChartConfig[] = [
  {
    ...
    dataKey: "dynamic",
    xKey: "lead_cualificacion.motivo_anulacion",
    size: "6",
    isVisible: true,
    isDonut: true,
  },
  {
    ...
    dataKey: "dynamic",
    xKey: "agendamientos.fecha_agendada_cliente",
    size: "6",
    isVisible: true,
  },
  {
  ...
  },
  {
    ...
    dataKey: "dynamic",
    xKey: "lead_cualificacion.cualificacion",
    size: "6",
    isVisible: true,
  },
  {
    id: "ch-8",
    type: "area",
    title: "Leads Ingresados por Fecha",
    dataKey: "dynamic",
    xKey: "lead.fecha_ingreso_crm",
    size: "6",
    isVisible: true,
...
export const DEFAULT_FUNNEL: KpiConfig[] = [
  ...
  {
    id: "fnl-2",
    label: "Leads Alcanzados",
    icon: "Phone",
    color: "bg-blue-500",
    size: "12",
    staticKey: "total_leads_alcanzados",
    isVisible: true,
    group: "FUNNEL",
    order: 2,
  },
...
export const WHATSAPP_KPIS: KpiConfig[] = [
  {
    id: "ws-1",
    label: "Leads con WhatsApp",
    icon: "MessageCircle",
    color: "bg-blue-600",
    size: "4",
    staticKey: "total_leads_unicos",
    isVisible: true,
  },
  {
    id: "ws-3",
...
export const DEFAULT_CHARTS_WHATSAPP: ChartConfig[] = [
  {
    ...
    dataKey: "dynamic",
    xKey: "conversaciones_whatsapp.fecha_ultimo_mensaje",
    size: "6",
    isVisible: true,
  },
  {
