...
import { getAIAgents, saveAIAgent, saveAgentVariant } from "../actions/agents";
    ...
    await (
      orchestrator as unknown as {
        executeAIAgentAction: (
          ...
          tenantId: string,
          rule: typeof mockRule
        ) => Promise<unknown>;
      }
    ).executeAIAgentAction(mockLead, "test-tenant", mockRule);
  }
