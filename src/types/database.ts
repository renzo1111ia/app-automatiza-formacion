...
export type Database = {
    public: {
        Tables: {
            ...
            advisors: { Row: { id: string; tenant_id: string; name: string; email: string | null; phone: string | null; is_active: boolean; specialties: string[] | null; handled_lead_types: string[] | null; origins: string[] | null; campaigns: string[] | null; countries: string[] | null; courses: string[] | null; created_at: string }; Insert: { tenant_id: string; name: string; email?: string | null; phone?: string | null; is_active?: boolean; specialties?: string[] | null; handled_lead_types?: string[] | null; origins?: string[] | null; campaigns?: string[] | null; countries?: string[] | null; courses?: string[] | null }; Update: Partial<{ name: string; email: string | null; phone: string | null; is_active: boolean; specialties: string[] | null; handled_lead_types: string[] | null; origins: string[] | null; campaigns: string[] | null; countries: string[] | null; courses: string[] | null }>; };
            ...
            appointments: { Row: { id: string; tenant_id: string; advisor_id: string | null; lead_id: string | null; scheduled_at: string; duration_minutes: number; status: string; notes: string | null; agent_used: string | null; ab_variant: string | null; created_at: string; updated_at: string; watchdog_processed: boolean; reminder_scheduled_at: string | null; reminder_sent_at: string | null }; Insert: { tenant_id: string; advisor_id?: string | null; lead_id?: string | null; scheduled_at: string; duration_minutes?: number; status?: string; notes?: string | null; agent_used?: string | null; ab_variant?: string | null; watchdog_processed?: boolean; reminder_scheduled_at?: string | null; reminder_sent_at?: string | null }; Update: Partial<{ advisor_id: string | null; status: string; notes: string | null; updated_at: string; watchdog_processed: boolean; reminder_scheduled_at: string | null; reminder_sent_at: string | null }>; };
