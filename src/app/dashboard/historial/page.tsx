...
export default async function HistorialPage({
  ...
  const columns = (tenant?.config as { historial_columns?: { key: string; label: string }[] })
    ?.historial_columns;
  ...
  return (
    <div className="space-y-4">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-foreground text-[32px] leading-tight font-bold tracking-tight">
            <span className="text-blue-600 dark:text-blue-400">Leads</span>
          </h1>
      ...
      <HistorialTable initialData={initialData} fromDate={from} toDate={to} columns={columns} />
