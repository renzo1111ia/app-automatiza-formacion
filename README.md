...
| Estado          | 🟡 **Sprint 3 Hardening EN CURSO** — `feature/sprint-03-hardening`. CLOSE-1+1.5+2 🟢 verdes (29-05). CLOSE-5 PR a developer en curso. 4 BUG-SEC abiertos (2 altos pre-deploy VPS, 2 medios backlog). Bloque 3.B movido a backlog post-MVP. |
...
| **3 Hardening**                   | `v0.3.0-rc.1` / **`v0.3.0` MVP GA** | 🟡 **En Curso**   | `feature/sprint-03-hardening` — 22/22 tareas dev pusheadas. CLOSE-1+1.5+2 🟢 (29-05). 4 BUG-SEC abiertos (2 altos pre-deploy VPS, 2 medios backlog). Bloque 3.B → backlog post-MVP. CLOSE-5 PR pendiente orden usuario.                 |
